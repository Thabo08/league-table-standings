...
def _cmd_args():
    ...
    parser.add_argument("--fileinput", type=str, help="Input file containing the game results")
    parser.add_argument("--cmdinput", type=str, help="Receive results from stdin")
    parser.add_argument("--fileoutput", type=str, help="Output file containing the league rankings")
